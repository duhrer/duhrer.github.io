...
fluid.registerNamespace("lpg.generator");

lpg.generator.makeBundle = function (that) {
...
fluid.defaults("lpg.generator", {
    gradeNames: ["fluid.component"],
    baseDir: "%launchpad-guitar",
    targetDir: "/Users/duhrer/Source/projects/duhrer.github.io/demos/launchpad-guitar",
    bundle: [
        "./index.html",
        "./src",
        "./images",
    ...
    listeners: {
        "onCreate.createBundle": {
            funcName: "lpg.generator.makeBundle",
            args:     ["{that}"]
        }
    }
});
