...
should invert part of a digit as it passes through it (in the video, you can see
how cleanly the original handles this). My first C version drew everything in
layers, so the second hand looked like it was partially erasing a digit until it
got halfway through it, and then the digit would invert, with its inverted
colour jumping a little ahead of the second hand. It was readable, but jerky.
